  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          <ListItem key= "Course" disablePadding sx={{display: 'block'}}>
            <ListItemButton sx={{
              minHeight: 48,
          ...
          <ListItem key= "Assignments_u" disablePadding sx={{display: 'block'}}>
            <ListItemButton sx={{
              ...
              <ListItemText primary="Due Assignments" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          <ListItem key= "assignments_f" disablePadding sx={{display: 'block'}}>
            <ListItemButton sx={{
              minHeight: 48,
              justifyContent: open ? 'initial' : 'center',
              px: 2.5,
        ...
        <ListItem key= "files" disablePadding sx={{display: 'block'}}>
            <ListItemButton sx={{
              ...
              <ListItemText primary="Course Materials" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
